...
load_pkgstats_data_internal <- function (datafile) {
    ...
    x$blank_lines_R <- as.integer (x$blank_lines_R)
    x$blank_lines_src <- as.integer (x$blank_lines_src)
    x$blank_lines_inst <- as.integer (x$blank_lines_inst)
    x$blank_lines_vignettes <- as.integer (x$blank_lines_vignettes)
    x$blank_lines_tests <- as.integer (x$blank_lines_tests)
    x$comment_lines_R <- as.integer (x$comment_lines_R)
    x$comment_lines_src <- as.integer (x$comment_lines_src)
    x$comment_lines_inst <- as.integer (x$comment_lines_inst)
    x$comment_lines_vignettes <- as.integer (x$comment_lines_vignettes)
    x$comment_lines_tests <- as.integer (x$comment_lines_tests)
    x$rel_space_R <- as.integer (x$rel_space_R)
    x$rel_space_src <- as.integer (x$rel_space_src)
    x$rel_space_inst <- as.integer (x$rel_space_inst)
    x$rel_space_vignettes <- as.integer (x$rel_space_vignettes)
    x$rel_space_tests <- as.integer (x$rel_space_tests)
    x$indentation <- as.integer (x$indentation)
