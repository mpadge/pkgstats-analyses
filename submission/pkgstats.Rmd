...
library), and "gtags", itself part of the GNU Global library. <!-- citations
for the software --> . Using these jointly enabled us to parse both R and other
languages used in packages, and construct a "call network" of functions between
languages: "ctags" parses R code and "gtags" does not, but "gtags" parses more
languages. We linked the results of two to provide complete coverage.
