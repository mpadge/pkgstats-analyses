...
fig01_png <- file.path (here, "vignettes", "figures", "fig01.png")
```
...
png (file.path (here, "vignettes", "figures", "fig01.png"),
     width = 7, height = 3.5, units = "in", res = 300)
p1 | p2
graphics.off ()
```

```{r fig1-num_aut_ctb2, echo = FALSE, out.width = 700, fig.cap = "**Figure 1.** second try"}
