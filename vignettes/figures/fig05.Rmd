...
```{r fig5-assemble, fig.width = 7, fig.height = 7, fig.cap = "**Fig. 5** Development of code metrics per release of each package."}
(p1 + p2) / (p3 + p4)
```
