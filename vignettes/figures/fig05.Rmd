...
f_fig5_exdat <- file.path (here, "vignettes", "fig5-ext-calls.Rds")
...
f_fig5_deps <- file.path (here, "vignettes", "fig5-deps.Rds")
...
```{r fig5-top10-file}
f_top10 <- file.path (here, "vignettes", "top10-pkgs.Rds")
