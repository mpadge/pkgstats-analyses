...
f_fig5_exdat <- file.path (v_data_dir, "fig05-ext-calls.Rds")
...
f_fig5_deps <- file.path (v_data_dir, "fig05-deps.Rds")
...
cp_dat_file <- file.path (v_data_dir, "fig05-coupling-data.Rds")
...
```{r fig5-top10-file}
f_top10 <- file.path (v_data_dir, "fig05-top10-pkgs.Rds")
