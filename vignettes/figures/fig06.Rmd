...
```{r Fig6-call-coupling-deps}
f <- file.path (here, "vignettes", "coupling_deps.Rds")
if (!file.exists (f)) {
...
```{r fig6-p1-deps}
f <- file.path (here, "vignettes", "fig6_deps_p1.Rds")
calc_fig6_p1_deps <- !file.exists (f)
```

```{r fig6-p1-deps-calc, eval = calc_fig6_p1_deps}
deps_p1 <- deps |>
