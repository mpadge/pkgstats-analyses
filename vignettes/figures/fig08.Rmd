...
```{r fig8-assemble, echo = FALSE, message = FALSE, fig.width = 7, fig.height = 7, fig.cap = "**Figure 8** Network metrics for (A-B) the CRAN dependency network, and (C-D) Function call networks within packages."}
