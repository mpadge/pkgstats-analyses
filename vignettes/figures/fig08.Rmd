...
coeff_fig8_p3 <- max (dat$n_clusters) / max (dat$n_edges)
colours_fig8_p3 <- c ("total" = "red",
                      "R" = "green",
                      "src" = "blue",
                      "n_clusters" = "orange")
fig8_p3 <- dat |>
    ...
    ggplot (aes (x = year)) +
        ...
        geom_line (aes (y = n_clusters / coeff_fig8_p3, col = "n_clusters")) +
        ...
        #geom_line (data = dat_cran, aes (y = n_clusters / coeff_fig8_p3, col = "n_clusters"), lty = 2) +
        #scale_colour_manual (values = colours_fig8_p3) +
        ylab ("Num. edges") +
        scale_y_continuous (
            sec.axis = sec_axis (~.*coeff_fig8_p3, name = "Num. clusters")) +
...
coeff_fig8_p4 <- max (dat$term_edges) / max (dat$centr_undir_mn)
colours_fig8_p4 <- c ("centr_undir" = "red",
                      "centr_dir" = "green",
                      "vert_degree" = "blue",
                      "term_edges" = "orange")
...
fig8_p4 <- dat |>
    ...
    ggplot (aes (x = year)) +
        ...
        geom_line (aes (y = vert_degree / coeff_fig8_p4, col = "vert_degree")) +
        geom_line (aes (y = term_edges / coeff_fig8_p4, col = "term_edges")) +
        ...
        scale_y_continuous (
            sec.axis = sec_axis (~.*coeff_fig8_p4, name = "Vert. degree (*10) / Term. edges")) +
...
```{r fig8-assemble, echo = FALSE, message = FALSE, fig.width = 7, fig.height = 7, fig.cap = "**Figure 8** Network metrics"}
