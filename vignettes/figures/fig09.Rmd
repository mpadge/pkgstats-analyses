...
```{r fig9-assemble, echo = FALSE, message = FALSE, fig.height = 3.5, fig.cap = "**Figure 9** Network metrics from function call networks as a function of release sequence."}
fig9_p1 + fig9_p2
```
