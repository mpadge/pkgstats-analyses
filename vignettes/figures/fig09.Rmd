...
graph_data_file <- file.path (v_data_dir, "graph-metrics.Rds")
graph_intern_data_file <- file.path (v_data_dir, "graph-metrics-intern.Rds")
...
graph_one_year <- function (xraw, year = 2015) {
...
saveRDS (dat, graph_intern_data_file)
```
