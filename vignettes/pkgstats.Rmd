...
`{pkgstats}` package and database.

## Methods

<!-- This section should be way longer. It should
- describe the availability of the full package database and where to download
  it
-->

We developed `{pkgstats}` to quantify the structure and content of R packages
using static code analysis techniques [@static-analysis-2016]. That package
[includes a function,
