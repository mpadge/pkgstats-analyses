...
Historically, the "evolution" of software has primarily focussed on individual
pieces of software [@syeed_evolution_2013], frequently referring to the work of
@software-evolution-97, who expressed their findings as a series of "laws" of
software evolution. These "laws" include that, over time, software increases
both in complexity and in functional content (or numbers of "modules"). Those
laws of growth themselves derive from @Turski96, who posited an inverse-square
law for software growth, later formalised in @Turski02, albeit as a purely
empirical exercise absent any firm theoretical reasoning.
...
that the "survival probability" (that a package is not updated at some time,
$t$) has been far greater for CRAN than for other package ecosystems, albeit
...
individual package distribution systems, such as the analysis of the Debian
...
over time, and claimed that this reflected the laws of @software-evolution-97,
...
were also relatively restricted to aggregate statistics only, with no analyses
of the internal properties of dependency networks themselves. Thus while this
