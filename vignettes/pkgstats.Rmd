...
package](https://docs.ropensci.org/pkgstats/), which we developed to quantify
the structure and content of R packages using static code analysis techniques.
Data for the present analyses were derived from [a function within the package,
