...
The temporal development of software has been studied for many decades, with
the majority of studies examining the development of individual pieces of
software or, in rarer cases, comparative studies between a select few pieces of
software. Open source software in many languages is, however, increasingly
dependent upon and therefore shaped by developments in other packages or
libraries. We therefore assert that the development or evolution of open source
software is better studies in *collective* rather than *individual* terms. A
...
context of the evolution of the ecosystem as a whole.
...
internal properties of dependency networks themselves.
...
content (or numbers of "modules"). Those laws of growth themselves derive from
...
@mining-repos-2013, who usefully identified a number of categories, including
that of "code statistics" examined here.
