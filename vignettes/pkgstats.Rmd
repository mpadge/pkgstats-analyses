...
`src` and `tests`, with the increase in the latter particularly distinct,
clearly indicating that packages have become both progressively better better
tested.
...
Figure 6 shows the temporal evolution of a number of code metrics. These
...
LoC per function (Fig. 6B), excepting the early years of CRAN, during which
